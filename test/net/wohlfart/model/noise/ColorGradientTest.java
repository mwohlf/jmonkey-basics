...
import net.wohlfart.model.noise.ColorGradient.GradientPoint;
...
public class ColorGradientTest {
	...
	public void threeColorSimple() {
		Color color;
		ColorGradient colorGradient = new ColorGradient(new Color(255,0,0), new Color(0,0,0), new Color(0,0,255));	
